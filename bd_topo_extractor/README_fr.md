...
Un clic sur le bouton `Documentation` permet d'ouvrir la [page github du plugin](https://framagit.org/JulesGrillot/plugin_bd_topo_extractor/tree/main/bd_topo_extractor#bd-topo-extractor---qgis-plugin).
...
Un fond de carte Plan IGN V2 est automatiquement ajouté au projet si il est vide lorsque le plugin est lancé. Afin de simplifier le traçage d'une emprise.
